...
@interface SQCollectionViewLayout()
//用来记录每一列的最大y值
...
@implementation SQCollectionViewLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //获取item的高度，由外界计算得到
    if (self.delegate) {
        CGSize delegateItemSize = [self.delegate waterfallLayout:self atIndexPath:indexPath];
        itemHeight = delegateItemSize.height / delegateItemSize.width * itemWidth;
    }
    //找出最短的那一列
